      ...
      <form @submit.prevent="register">
        ...
        <div class="relative z-0 w-full mb-5">
          ...
          <label
            for="nickname"
            class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500"
            >Введите никнейм</label
          >
          <span class="text-sm text-red-600" id="error" v-if="noNickname"
            >Необходимо ввести никнейм</span
          >
        </div>
        <div class="relative z-0 w-full mb-5">
          <input
  ...
  methods: {
    async register() {
      ...
      try {
        ...
        this.isError = false;
        this.alertText = "Регистрация прошла успешно!";
        this.alertOpen = true;
      } catch (error) {
        this.isError = true;
        this.alertText = "Во время регистрации произошла ошибка";
        this.alertOpen = true;
      }
    },
    closeAlert: function () {
